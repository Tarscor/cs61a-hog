...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    highest=1
    while num_rolls<=10:
        if make_averaged(roll_dice)(num_rolls,dice)>make_averaged(roll_dice)(highest,dice):
            highest=num_rolls
        num_rolls+=1
    return highest
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    swap=is_swap(score+bacon,opponent_score)
    if opponent_score>bacon+score and swap:
        return 0
    elif bacon>=margin:
        return 0
    else:
...
def final_strategy(score, opponent_score):
    """Brief description of your final strategy.
    """
    return 4
